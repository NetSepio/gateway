...
// IsRevealed is a free data retrieval call binding the contract method 0x54214f69.
//
// Solidity: function isRevealed() view returns(bool)
func (_Contract *ContractCaller) IsRevealed(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "isRevealed")
...
//
// Solidity: function isRevealed() view returns(bool)
func (_Contract *ContractSession) IsRevealed() (bool, error) {
	return _Contract.Contract.IsRevealed(&_Contract.CallOpts)
}

// IsRevealed is a free data retrieval call binding the contract method 0x54214f69.
//
// Solidity: function isRevealed() view returns(bool)
func (_Contract *ContractCallerSession) IsRevealed() (bool, error) {
	return _Contract.Contract.IsRevealed(&_Contract.CallOpts)
}
...
func (_Contract *ContractCaller) MaxSupply(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "maxSupply")
...
// DelegateMint is a paid mutator transaction binding the contract method 0x0bfd468f.
//
// Solidity: function delegateMint(address to) returns()
func (_Contract *ContractTransactor) DelegateMint(opts *bind.TransactOpts, to common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "delegateMint", to)
}

// DelegateMint is a paid mutator transaction binding the contract method 0x0bfd468f.
//
// Solidity: function delegateMint(address to) returns()
func (_Contract *ContractSession) DelegateMint(to common.Address) (*types.Transaction, error) {
	return _Contract.Contract.DelegateMint(&_Contract.TransactOpts, to)
}

// DelegateMint is a paid mutator transaction binding the contract method 0x0bfd468f.
//
// Solidity: function delegateMint(address to) returns()
func (_Contract *ContractTransactorSession) DelegateMint(to common.Address) (*types.Transaction, error) {
	return _Contract.Contract.DelegateMint(&_Contract.TransactOpts, to)
}
...
//
// Solidity: function reveal(string uri) returns()
func (_Contract *ContractTransactor) Reveal(opts *bind.TransactOpts, uri string) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "reveal", uri)
}

// Reveal is a paid mutator transaction binding the contract method 0x4c261247.
//
// Solidity: function reveal(string uri) returns()
func (_Contract *ContractSession) Reveal(uri string) (*types.Transaction, error) {
	return _Contract.Contract.Reveal(&_Contract.TransactOpts, uri)
}

// Reveal is a paid mutator transaction binding the contract method 0x4c261247.
//
// Solidity: function reveal(string uri) returns()
func (_Contract *ContractTransactorSession) Reveal(uri string) (*types.Transaction, error) {
	return _Contract.Contract.Reveal(&_Contract.TransactOpts, uri)
}
...
//
// Solidity: function setBaseURI(string _baseURL) returns()
func (_Contract *ContractTransactor) SetBaseURI(opts *bind.TransactOpts, _baseURL string) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "setBaseURI", _baseURL)
}

// SetBaseURI is a paid mutator transaction binding the contract method 0x55f804b3.
//
// Solidity: function setBaseURI(string _baseURL) returns()
func (_Contract *ContractSession) SetBaseURI(_baseURL string) (*types.Transaction, error) {
	return _Contract.Contract.SetBaseURI(&_Contract.TransactOpts, _baseURL)
}

// SetBaseURI is a paid mutator transaction binding the contract method 0x55f804b3.
//
// Solidity: function setBaseURI(string _baseURL) returns()
func (_Contract *ContractTransactorSession) SetBaseURI(_baseURL string) (*types.Transaction, error) {
	return _Contract.Contract.SetBaseURI(&_Contract.TransactOpts, _baseURL)
}
...
//
// Solidity: event NFTMinted(uint256 tokendId, address indexed owner)
