...
// NETSEPIOREVIEWERROLE is a free data retrieval call binding the contract method 0xc7094b4e.
//
// Solidity: function NETSEPIO_REVIEWER_ROLE() view returns(bytes32)
func (_Netsepio *NetsepioCaller) NETSEPIOREVIEWERROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Netsepio.contract.Call(opts, &out, "NETSEPIO_REVIEWER_ROLE")
...
//
// Solidity: function NETSEPIO_REVIEWER_ROLE() view returns(bytes32)
func (_Netsepio *NetsepioSession) NETSEPIOREVIEWERROLE() ([32]byte, error) {
	return _Netsepio.Contract.NETSEPIOREVIEWERROLE(&_Netsepio.CallOpts)
}

// NETSEPIOREVIEWERROLE is a free data retrieval call binding the contract method 0xc7094b4e.
//
// Solidity: function NETSEPIO_REVIEWER_ROLE() view returns(bytes32)
func (_Netsepio *NetsepioCallerSession) NETSEPIOREVIEWERROLE() ([32]byte, error) {
	return _Netsepio.Contract.NETSEPIOREVIEWERROLE(&_Netsepio.CallOpts)
}
...
//
// Solidity: function delegateReviewCreation(string category, string domainAddress, string siteURL, string siteType, string siteTag, string siteSafety, string metadataURI, address reviewer) returns()
func (_Netsepio *NetsepioTransactor) DelegateReviewCreation(opts *bind.TransactOpts, category string, domainAddress string, siteURL string, siteType string, siteTag string, siteSafety string, metadataURI string, reviewer common.Address) (*types.Transaction, error) {
	return _Netsepio.contract.Transact(opts, "delegateReviewCreation", category, domainAddress, siteURL, siteType, siteTag, siteSafety, metadataURI, reviewer)
}

// DelegateReviewCreation is a paid mutator transaction binding the contract method 0xb1c58bba.
//
// Solidity: function delegateReviewCreation(string category, string domainAddress, string siteURL, string siteType, string siteTag, string siteSafety, string metadataURI, address reviewer) returns()
func (_Netsepio *NetsepioSession) DelegateReviewCreation(category string, domainAddress string, siteURL string, siteType string, siteTag string, siteSafety string, metadataURI string, reviewer common.Address) (*types.Transaction, error) {
	return _Netsepio.Contract.DelegateReviewCreation(&_Netsepio.TransactOpts, category, domainAddress, siteURL, siteType, siteTag, siteSafety, metadataURI, reviewer)
}

// DelegateReviewCreation is a paid mutator transaction binding the contract method 0xb1c58bba.
//
// Solidity: function delegateReviewCreation(string category, string domainAddress, string siteURL, string siteType, string siteTag, string siteSafety, string metadataURI, address reviewer) returns()
func (_Netsepio *NetsepioTransactorSession) DelegateReviewCreation(category string, domainAddress string, siteURL string, siteType string, siteTag string, siteSafety string, metadataURI string, reviewer common.Address) (*types.Transaction, error) {
	return _Netsepio.Contract.DelegateReviewCreation(&_Netsepio.TransactOpts, category, domainAddress, siteURL, siteType, siteTag, siteSafety, metadataURI, reviewer)
}
